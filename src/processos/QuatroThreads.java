...
public class QuatroThreads {
	...
	public QuatroThreads(int tam) {
		...
		/*PRIMEIRA THREAD - CALCULA ELEMENTOS CONTIDOS ENTRE A 
		 PRIMEIRA COLUNA E A COLUNA DO MEIO, E ENTRE A PRIMEIRA LINHA E A LINHA DO MEIO*/
		inicio1 = 1;
		fim1 = tam/2;
		inicio2 = 1;
		fim2 = tam / 2;
		MyThread(inicio1, fim1, inicio2, fim2);
		/*SEGUNDA THREAD - CALCULA ELEMENTOS CONTIDOS ENTRE A 
		 PRIMEIRA COLUNA E A COLUNA DO MEIO, E ENTRE A LINHA DO MEIO E A ÚLTIMA LINHA*/
		inicio1 = tam/2;
		fim1 = tam-1;
		inicio2 = 1;
		fim2 = tam / 2;
		MyThread(inicio1, fim1, inicio2, fim2);
		/*TERCEIRA THREAD - CALCULA ELEMENTOS CONTIDOS ENTRE A 
		 COLUNA DO MEIO E A ÚLTIMA COLUNA, E ENTRE A PRIMEIRA LINHA E A LINHA DO MEIO*/
		inicio1 = 1;
		fim1 = tam/2;
		inicio2 = tam/2;
		fim2 = tam-1;
		MyThread(inicio1, fim1, inicio2, fim2);
		/*QUARTA THREAD - CALCULA ELEMENTOS CONTIDOS ENTRE A 
		 COLUNA DO MEIO E A ÚLTIMA COLUNA, E ENTRE A LINHA DO MEIO E A ÚLTIMA LINHA*/
		inicio1 = tam/2;
		fim1 = tam-1;
		inicio2 = tam/2;
		fim2 = tam-1;
